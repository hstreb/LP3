...
public class InterfaceDoUsuario {
	...
	public InterfaceDoUsuario(MotoristaService motoristaService, PassageiroService passageiroService,
			ViagemService viagemService, FormatadorDeData formatadorDeData) {
		this.motoristaService = motoristaService;
		this.passageiroService = passageiroService;
		this.viagemService = viagemService;
		this.scanner = new Scanner(System.in);
		this.formatadorDeData = formatadorDeData;
	}
...
//			return true;
	...
	private void adicionarViagem() {
		...
		LocalDate dataViagem = formatadorDeData.formatar(scanner.next());
	...
	private void calcularValorAReceberMotorista() {
		...
		LocalDate inicio = formatadorDeData.formatar(dataInicio);
		LocalDate fim = formatadorDeData.formatar(datafim);
